...
$entryStockQuery = ("INSERT INTO entradas (codigof, provedor, cantidad, producto_id, user_id, created_at, updated_at) VALUES ('$newFifo', '$proveedor', '$newCantidad', '$id', '1', '$fecha', '$fecha')");
